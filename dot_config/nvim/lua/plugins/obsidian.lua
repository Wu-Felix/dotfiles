return {
  {
    ...
    opts = {
      ...
      workspaces = {
        {
          name = "StudyAreas",
          path = "~/OneDrive/obsidian/StudyAreas/",
        },
        {
          name = "WorkAreas",
          path = "~/OneDrive/obsidian/WorkAreas/",
        },
      },
      ...
      notes_subdir = "resource/notes", -- Subdirectory for notes
      new_notes_location = "resource", -- Location for new notes
      -- Settings for attachments
      attachments = {
        img_folder = "resource/image", -- Folder for image attachments
      },
      -- Settings for daily notes
      daily_notes = {
        -- Optional, if you keep daily notes in a separate directory.
        folder = "resource/dailies",
